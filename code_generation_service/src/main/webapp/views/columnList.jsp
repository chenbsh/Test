...
<form id="insertForm" name="insertForm" method="post">
	<table width="99.5%" height="1px" border="0" align="center" cellspacing="0" cellpadding="0" style="margin-top:5px;">
		...
		<tr height="1px">
			<td align="center">
				<table width="98%" height="100%" border="0" align="center" cellspacing="0" cellpadding="0" style="background-color: #F0F0F0; border:1px solid #0875D2;">
					<tr height="1px">
						<td width="10%" class="table_title">库实例名称</td>
						<td width="23.33%" class="table_record">${databaseName}&nbsp;</td>
						<td width="10%" class="table_title">新增数据函数</td>
						<td width="23.33%" class="table_record"><input type="checkbox" name="defaultMethod" value="insert" checked="checked"/> <span style="font-weight: bold;">insert</span></td>
						<td width="10%" class="table_title">批量新增函数</td>
						<td width="23.34%" class="table_record"><input type="checkbox" name="defaultMethod" value="insertBatch" /> <span style="font-weight: bold;">insertBatch</span></td>
					</tr>
					<tr height="1px">
						<td class="table_title">数据表名称</td>
						<td class="table_record">${tableName}&nbsp;</td>
						<td class="table_title">更新数据函数</td>
						<td class="table_record"><input type="checkbox" name="defaultMethod" value="update" checked="checked"/> <span style="font-weight: bold;">update</span></td>
						<td class="table_title">动态字段更新</td>
						<td class="table_record"><input type="checkbox" name="defaultMethod" value="updateDynamicField"/> <span style="font-weight: bold;">updateDynamicField</span></td>
					</tr>
					<tr height="1px">
						<td class="table_title">数据表注解</td>
						<td class="table_record"><input type="text" class="formInputText" id="tableComment" name="tableComment" value="${tableComment}" maxlength="128" placeholder="例如：系统权限菜单" style="font-weight: bold;width:100%;"/></td>
						<td class="table_title">参数查询函数</td>
						<td class="table_record"><input type="checkbox" name="defaultMethod" value="condition" checked="checked"/> <span style="font-weight: bold;">queryForListByCondition</span></td>
						<td class="table_title"></td>
						<td class="table_record"></td>
					</tr>
					<tr height="1px">
						<td class="table_title">程序包名称</td>
						<td class="table_record"><input type="text" class="formInputText" id="packageName" name="packageName" value="${packageName}" maxlength="128" placeholder="例如：com.coding.basic"style="font-weight: bold;width:100%;"/></td>
						<td class="table_title">参数统计函数</td>
						<td class="table_record"><input type="checkbox" name="defaultMethod" value="statistics" checked="checked"/> <span style="font-weight: bold;">statisticsForListByCondition</span></td>
						<td class="table_title"></td>
						<td class="table_record"></td>
					</tr>
					<tr height="0px">
		...
		<tr height="1px">
			<td align="center">
				<table width="98%" height="100%" border="0" align="center" cellspacing="0" cellpadding="0" style="background-color: #F0F0F0; border:1px solid #0875D2;">
					<tr height="1px">
						<td width="6%" class="table_title">列字段名称</td>
						<td width="6%" class="table_title">数据库类型</td>
						<td width="6%" class="table_title">Java类型</td>
						<td width="15.25%" class="table_title">数据库注解</td>
						<td width="6%" class="table_title">列字段名称</td>
						<td width="7%" class="table_title">列注解定义</td>
						<td width="4%" class="table_title">主键定义</td>
						<td width="4%" class="table_title">动态查询</td>
						<td width="4%" class="table_title">列表显示</td>
						<td width="4%" class="table_title"><font color="#FFFF00">表单不显</font></td>
						<td width="37.75%" class="table_title"></td>
					</tr>
					...
					<tr height="1px" class="table_tr" onmouseout="this.className='table_tr'" onmousemove="this.className='table_tr_over'">
						...
						<td class="table_record_center"></td>
					</tr>
					</c:forEach>
				</table>
			</td>
		...
		<tr height="1px">
			<td align="center">
				<table width="98%" height="100%" border="0" align="center" cellspacing="0" cellpadding="0" style="background-color: #F0F0F0; border:1px solid #0875D2;">
					<tr height="1px">
						<td width="6%" class="table_title">列字段名称</td>
						<td width="27%" class="table_title">数据删除函数</td>
						<td width="6%" class="table_title">列字段名称</td>
						<td width="27%" class="table_title">单条查询函数</td>
						<td width="6%" class="table_title">列字段名称</td>
						<td width="28%" class="table_title">列表查询函数</td>
					</tr>
					<c:forEach var="entity" items="${columnList}" step="1" varStatus="forstatus">
					<c:choose>
					<c:when test="${forstatus.index%2==0}">
					...
					<tr height="1px" class="table_tr" onmouseout="this.className='table_tr'" onmousemove="this.className='table_tr_over'">
						...
						<td class="table_record">
							<table width="100%" height="1px" border="0" align="left" cellspacing="0" cellpadding="0">
								<tr height="1px">
									<td width="5%" align="center"><input type="checkbox" id="usedCheck" name="usedCheck" value="${entity.columnName}"></td>
									<td width="10%" align="center"><input type="button" id="${entity.columnName}_remove_method_button" name="${entity.columnName}_remove_method_button" value=" 设  置  " onclick="createMethod('${entity.columnName}','${entity.javaSimpleType}','remove');" /></td>
									<td width="85%">
										<input type="hidden" id="${entity.columnName}_remove" name="${entity.columnName}_remove" value=""/>
										<input type="text" class="formInputText" id="${entity.columnName}_remove_method" name="${entity.columnName}_remove_method" value="" placeholder="函数名称自动生成" readonly="readonly" style="font-weight: bold;padding-left:3%;"/>
									</td>
								</tr>
							</table>
						</td>
						...
						<td class="table_record">
							<table width="100%" height="1px" border="0" align="left" cellspacing="0" cellpadding="0">
								<tr height="1px">
									<td width="10%" align="center"><input type="button" id="${entity.columnName}_bean_method_button" name="${entity.columnName}_bean_method_button" value=" 设  置  " onclick="createMethod('${entity.columnName}','${entity.javaSimpleType}','bean');" /></td>
									<td width="90%">
										<input type="hidden" id="${entity.columnName}_bean" name="${entity.columnName}_bean" value=""/>
										<input type="text" class="formInputText" id="${entity.columnName}_bean_method" name="${entity.columnName}_bean_method" value="" placeholder="函数名称自动生成" readonly="readonly" style="font-weight: bold;padding-left:3%;"/>
									</td>
								</tr>
							</table>
						</td>
						...
						<td class="table_record">
							<table width="100%" height="1px" border="0" align="left" cellspacing="0" cellpadding="0">
								<tr height="1px">
									<td width="10%" align="center"><input type="button" id="${entity.columnName}_list_method_button" name="${entity.columnName}_list_method_button" value=" 设  置  " onclick="createMethod('${entity.columnName}','${entity.javaSimpleType}','list');" /></td>
									<td width="90%">
										<input type="hidden" id="${entity.columnName}_list" name="${entity.columnName}_list" value=""/>
										<input type="text" class="formInputText" id="${entity.columnName}_list_method" name="${entity.columnName}_list_method" value="" placeholder="函数名称自动生成" readonly="readonly" style="font-weight: bold;padding-left:3%;"/>
									</td>
								</tr>
							</table>
						</td>
...
<script type="text/javascript">
	...
	function resetConfigForm(){
		...
		<c:if test="${entity.usedCheck}">
		elements = document.getElementsByName("usedCheck");
		for(var i=0;i<elements.length;i++){
			if(elements[i].value=="${entity.columnName}"){
				elements[i].checked = true;
				break;
