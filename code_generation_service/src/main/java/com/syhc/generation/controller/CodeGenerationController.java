...
public class CodeGenerationController extends ParentController {
    ...
    private ModelAndView columnList(String tableComment, String tableName, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (StringUtils.isNotBlank(tableComment)) {
            view.addObject("tableComment", tableComment.replace("信息表", ""));
        }
