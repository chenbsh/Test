 ...
 */
@Repository
public class CreateMainTestLogicService {
	...
	public String test(String tableName, String tableComment, String packageName, String codingHead, Collection<TableColumnBean> columnList, String defaultMethod[]) {
		...
		persistence.append("import org.springframework.context.ApplicationContext;\n");
		persistence.append("import org.springframework.context.support.FileSystemXmlApplicationContext;\n");
		...
		persistence.append("import org.apache.logging.log4j.core.config.Configurator;\n");
		...
		persistence.append("*/\n\n");
		persistence.append("public class " + codingHead + "ExternalServiceTest {\n\n");

		persistence.append("public " + codingHead + "ExternalServiceTest() {\n");
		persistence.append("super();\n");
		persistence.append("}\n\n");

		persistence.append("ApplicationContext ctx = new FileSystemXmlApplicationContext(\"classpath:applicationContext-core.xml\");\n");
		persistence.append(codingHead + "ExternalService external = (" + codingHead + "ExternalService) ctx.getBean(\"" + codingHead.substring(0, 1).toLowerCase() + codingHead.substring(1, codingHead.length()) + "ExternalService\");");

		persistence.append("\n");
		persistence.append("public static void main(String[] args) {\n");
		persistence.append("Configurator.initialize(\"log4j2\", \"classpath:syhc_iot_core_log4j2.xml\");\n");
		persistence.append(codingHead + "ExternalServiceTest test = new " + codingHead + "ExternalServiceTest();\n");
		persistence.append("System.exit(0);\n");
		persistence.append("}\n");
	...
	private String testInsert(String tableComment, String codingHead, Collection<TableColumnBean> columnList) {
		StringBuilder insert = new StringBuilder("/**新增" + tableComment + "信息实例*/\n");
	...
	private String testInsertBatch(String tableComment, String codingHead, Collection<TableColumnBean> columnList) {
		StringBuilder insert = new StringBuilder("/**批量新增" + tableComment + "信息实例*/\n");
	...
	private String testUpdate(String tableComment, String codingHead, Collection<TableColumnBean> columnList) {
		StringBuilder insert = new StringBuilder("/**更新" + tableComment + "信息实例*/\n");
	...
	private String testDelete(String tableComment, String codingHead, TableColumnBean column) {
		...
		StringBuilder insert = new StringBuilder("/**根据" + column.getColumnComment() + "删除" + tableComment + "信息实例*/\n");
	...
	private String testBean(String tableComment, String codingHead, TableColumnBean column) {
		...
		StringBuilder insert = new StringBuilder("/**根据" + column.getColumnComment() + "获取" + tableComment + "信息实例*/\n");
		insert.append("public void " + mothedName + "() {\n");
	...
	private String testList(String tableComment, String codingHead, TableColumnBean column) {
		...
		StringBuilder insert = new StringBuilder("/**根据" + column.getColumnComment() + "获取" + tableComment + "信息实例集合*/\n");
		insert.append("public void " + mothedName + "() {\n");
	...
	private String testCondition(String tableComment, String codingHead) {
		StringBuilder insert = new StringBuilder("/**根据动态查询条件获取" + tableComment + "信息实例集合*/\n");
	...
	private String testStatistics(String tableComment, String codingHead) {
		StringBuilder insert = new StringBuilder("/**根据动态条件统计满足条件" + tableComment + "信息实例记录数*/\n");
